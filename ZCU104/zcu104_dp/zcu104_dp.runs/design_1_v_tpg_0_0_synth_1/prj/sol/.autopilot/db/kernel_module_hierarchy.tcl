...
"SubInsts" : [
	{"Name" : "grp_v_tpgHlsDataFlow_fu_442","ID" : "1","Type" : "dataflow",
		"SubInsts" : [
		{"Name" : "tpgBackground_U0","ID" : "2","Type" : "sequential",
			...
			{"Name" : "grp_tpgBackground_Pipeline_VITIS_LOOP_565_2_fu_482","ID" : "4","Type" : "sequential",
					...
					"SubInsts" : [
					{"Name" : "grp_reg_ap_uint_10_s_fu_1713","ID" : "6","Type" : "pipeline"},
					{"Name" : "grp_reg_int_s_fu_2208","ID" : "7","Type" : "pipeline"},]},]},]},]},
	...
	{"Name" : "grp_reg_unsigned_short_s_fu_622","ID" : "17","Type" : "pipeline"},]
}]}