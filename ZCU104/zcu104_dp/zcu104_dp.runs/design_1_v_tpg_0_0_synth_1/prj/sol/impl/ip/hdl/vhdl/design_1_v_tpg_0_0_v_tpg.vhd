...
architecture behav of design_1_v_tpg_0_0_v_tpg is 
    ...
    signal icmp_ln500_fu_628_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln500_reg_707 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal add_ln502_fu_638_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal add_ln502_reg_711 : STD_LOGIC_VECTOR (31 downto 0);
    signal height_read_reg_720 : STD_LOGIC_VECTOR (15 downto 0);
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal width_read_reg_725 : STD_LOGIC_VECTOR (15 downto 0);
    signal field_id_read_reg_730 : STD_LOGIC_VECTOR (15 downto 0);
    signal bckgndId_read_reg_735 : STD_LOGIC_VECTOR (7 downto 0);
    signal ovrlayId_read_reg_740 : STD_LOGIC_VECTOR (7 downto 0);
    signal maskId_read_reg_745 : STD_LOGIC_VECTOR (7 downto 0);
    signal motionSpeed_read_reg_750 : STD_LOGIC_VECTOR (7 downto 0);
    signal colorFormat_read_reg_755 : STD_LOGIC_VECTOR (7 downto 0);
    signal crossHairX_read_reg_760 : STD_LOGIC_VECTOR (15 downto 0);
    signal crossHairY_read_reg_765 : STD_LOGIC_VECTOR (15 downto 0);
    signal ZplateHorContStart_read_reg_770 : STD_LOGIC_VECTOR (15 downto 0);
    signal ZplateHorContDelta_read_reg_775 : STD_LOGIC_VECTOR (15 downto 0);
    signal ZplateVerContStart_read_reg_780 : STD_LOGIC_VECTOR (15 downto 0);
    signal ZplateVerContDelta_read_reg_785 : STD_LOGIC_VECTOR (15 downto 0);
    signal boxSize_read_reg_790 : STD_LOGIC_VECTOR (15 downto 0);
    signal empty_fu_695_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal empty_reg_795 : STD_LOGIC_VECTOR (7 downto 0);
    signal empty_84_fu_699_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal empty_84_reg_800 : STD_LOGIC_VECTOR (7 downto 0);
    signal empty_85_fu_703_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal empty_85_reg_805 : STD_LOGIC_VECTOR (7 downto 0);
    signal dpDynamicRange_read_reg_810 : STD_LOGIC_VECTOR (7 downto 0);
    signal dpYUVCoef_read_reg_815 : STD_LOGIC_VECTOR (7 downto 0);
    signal ap_CS_fsm_state4 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state4 : signal is "none";
    signal grp_v_tpgHlsDataFlow_fu_442_m_axis_video_TDATA : STD_LOGIC_VECTOR (23 downto 0);
    signal grp_v_tpgHlsDataFlow_fu_442_m_axis_video_TKEEP : STD_LOGIC_VECTOR (2 downto 0);
    signal grp_v_tpgHlsDataFlow_fu_442_m_axis_video_TSTRB : STD_LOGIC_VECTOR (2 downto 0);
    signal grp_v_tpgHlsDataFlow_fu_442_m_axis_video_TUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_v_tpgHlsDataFlow_fu_442_m_axis_video_TLAST : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_v_tpgHlsDataFlow_fu_442_m_axis_video_TID : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_v_tpgHlsDataFlow_fu_442_m_axis_video_TDEST : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_v_tpgHlsDataFlow_fu_442_fid : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_v_tpgHlsDataFlow_fu_442_ap_start : STD_LOGIC;
    signal grp_v_tpgHlsDataFlow_fu_442_m_axis_video_TVALID : STD_LOGIC;
    signal grp_v_tpgHlsDataFlow_fu_442_m_axis_video_TREADY : STD_LOGIC;
    signal grp_v_tpgHlsDataFlow_fu_442_fid_ap_vld : STD_LOGIC;
    signal grp_v_tpgHlsDataFlow_fu_442_ap_done : STD_LOGIC;
    signal grp_v_tpgHlsDataFlow_fu_442_ap_ready : STD_LOGIC;
    signal grp_v_tpgHlsDataFlow_fu_442_ap_idle : STD_LOGIC;
    signal grp_v_tpgHlsDataFlow_fu_442_ap_continue : STD_LOGIC;
    signal grp_reg_unsigned_short_s_fu_622_ap_return : STD_LOGIC_VECTOR (15 downto 0);
    signal ap_phi_mux_count_new_0_phi_fu_435_p4 : STD_LOGIC_VECTOR (31 downto 0);
    signal icmp_ln503_fu_644_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_v_tpgHlsDataFlow_fu_442_ap_start_reg : STD_LOGIC := '0';
    signal ap_CS_fsm_state5 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state5 : signal is "none";
    signal ap_sync_grp_v_tpgHlsDataFlow_fu_442_ap_ready : STD_LOGIC;
    signal ap_sync_grp_v_tpgHlsDataFlow_fu_442_ap_done : STD_LOGIC;
    signal ap_block_state5_on_subcall_done : BOOLEAN;
    signal ap_sync_reg_grp_v_tpgHlsDataFlow_fu_442_ap_ready : STD_LOGIC := '0';
    signal ap_sync_reg_grp_v_tpgHlsDataFlow_fu_442_ap_done : STD_LOGIC := '0';
    signal select_ln505_fu_675_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_1_fu_653_p4 : STD_LOGIC_VECTOR (28 downto 0);
    signal icmp_ln505_fu_663_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal add_ln507_fu_669_p2 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    grp_v_tpgHlsDataFlow_fu_442 : component design_1_v_tpg_0_0_v_tpgHlsDataFlow
    port map (
    ...
    grp_reg_unsigned_short_s_fu_622 : component design_1_v_tpg_0_0_reg_unsigned_short_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        d => bck_motion_en,
    ...
    ap_sync_reg_grp_v_tpgHlsDataFlow_fu_442_ap_done_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ap_sync_reg_grp_v_tpgHlsDataFlow_fu_442_ap_done <= ap_const_logic_0;
            else
                if (((ap_const_boolean_0 = ap_block_state5_on_subcall_done) and (ap_const_logic_1 = ap_CS_fsm_state5))) then 
                    ap_sync_reg_grp_v_tpgHlsDataFlow_fu_442_ap_done <= ap_const_logic_0;
                elsif ((grp_v_tpgHlsDataFlow_fu_442_ap_done = ap_const_logic_1)) then 
                    ap_sync_reg_grp_v_tpgHlsDataFlow_fu_442_ap_done <= ap_const_logic_1;
                end if; 
            end if;
        end if;
    end process;
    ...
    ap_sync_reg_grp_v_tpgHlsDataFlow_fu_442_ap_ready_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ap_sync_reg_grp_v_tpgHlsDataFlow_fu_442_ap_ready <= ap_const_logic_0;
            else
                if (((ap_const_boolean_0 = ap_block_state5_on_subcall_done) and (ap_const_logic_1 = ap_CS_fsm_state5))) then 
                    ap_sync_reg_grp_v_tpgHlsDataFlow_fu_442_ap_ready <= ap_const_logic_0;
                elsif ((grp_v_tpgHlsDataFlow_fu_442_ap_ready = ap_const_logic_1)) then 
                    ap_sync_reg_grp_v_tpgHlsDataFlow_fu_442_ap_ready <= ap_const_logic_1;
                end if; 
            end if;
        end if;
    end process;
    ...
    grp_v_tpgHlsDataFlow_fu_442_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                grp_v_tpgHlsDataFlow_fu_442_ap_start_reg <= ap_const_logic_0;
            else
                if (((ap_const_logic_1 = ap_CS_fsm_state4) or ((ap_sync_grp_v_tpgHlsDataFlow_fu_442_ap_ready = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state5)))) then 
                    grp_v_tpgHlsDataFlow_fu_442_ap_start_reg <= ap_const_logic_1;
                elsif ((grp_v_tpgHlsDataFlow_fu_442_ap_ready = ap_const_logic_1)) then 
                    grp_v_tpgHlsDataFlow_fu_442_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln500_reg_707 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln500_reg_707 = ap_const_lv1_1) and (icmp_ln503_fu_644_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
    ...
    add_ln502_fu_638_p2 <= std_logic_vector(unsigned(count) + unsigned(ap_const_lv32_1));
    add_ln507_fu_669_p2 <= std_logic_vector(unsigned(s) + unsigned(ap_const_lv32_1));
    ...
    ap_block_state5_on_subcall_done_assign_proc : process(ap_sync_grp_v_tpgHlsDataFlow_fu_442_ap_ready, ap_sync_grp_v_tpgHlsDataFlow_fu_442_ap_done)
    begin
                ap_block_state5_on_subcall_done <= ((ap_sync_grp_v_tpgHlsDataFlow_fu_442_ap_ready and ap_sync_grp_v_tpgHlsDataFlow_fu_442_ap_done) = ap_const_logic_0);
    end process;
    ...
    ap_phi_mux_count_new_0_phi_fu_435_p4_assign_proc : process(icmp_ln500_reg_707, add_ln502_reg_711, ap_CS_fsm_state3, icmp_ln503_fu_644_p2)
    begin
        if (((icmp_ln500_reg_707 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
            if ((icmp_ln503_fu_644_p2 = ap_const_lv1_0)) then 
                ap_phi_mux_count_new_0_phi_fu_435_p4 <= add_ln502_reg_711;
            elsif ((icmp_ln503_fu_644_p2 = ap_const_lv1_1)) then 
                ap_phi_mux_count_new_0_phi_fu_435_p4 <= ap_const_lv32_0;
            else 
                ap_phi_mux_count_new_0_phi_fu_435_p4 <= "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX";
            end if;
        else 
            ap_phi_mux_count_new_0_phi_fu_435_p4 <= "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX";
        end if; 
    ...
    ap_sync_grp_v_tpgHlsDataFlow_fu_442_ap_done <= (grp_v_tpgHlsDataFlow_fu_442_ap_done or ap_sync_reg_grp_v_tpgHlsDataFlow_fu_442_ap_done);
    ap_sync_grp_v_tpgHlsDataFlow_fu_442_ap_ready <= (grp_v_tpgHlsDataFlow_fu_442_ap_ready or ap_sync_reg_grp_v_tpgHlsDataFlow_fu_442_ap_ready);
    empty_84_fu_699_p1 <= boxColorG(8 - 1 downto 0);
    empty_85_fu_703_p1 <= boxColorB(8 - 1 downto 0);
    empty_fu_695_p1 <= boxColorR(8 - 1 downto 0);
    fid <= grp_v_tpgHlsDataFlow_fu_442_fid;

    grp_v_tpgHlsDataFlow_fu_442_ap_continue_assign_proc : process(ap_CS_fsm_state5, ap_block_state5_on_subcall_done)
    begin
        if (((ap_const_boolean_0 = ap_block_state5_on_subcall_done) and (ap_const_logic_1 = ap_CS_fsm_state5))) then 
            grp_v_tpgHlsDataFlow_fu_442_ap_continue <= ap_const_logic_1;
        else 
            grp_v_tpgHlsDataFlow_fu_442_ap_continue <= ap_const_logic_0;
        end if; 
    end process;

    grp_v_tpgHlsDataFlow_fu_442_ap_start <= grp_v_tpgHlsDataFlow_fu_442_ap_start_reg;
    grp_v_tpgHlsDataFlow_fu_442_m_axis_video_TREADY <= (m_axis_video_TREADY_int_regslice and ap_CS_fsm_state5);
    icmp_ln500_fu_628_p2 <= "1" when (grp_reg_unsigned_short_s_fu_622_ap_return = ap_const_lv16_1) else "0";
    icmp_ln503_fu_644_p2 <= "1" when (add_ln502_reg_711 = ap_const_lv32_A) else "0";
    icmp_ln505_fu_663_p2 <= "1" when (signed(tmp_1_fu_653_p4) < signed(ap_const_lv29_1)) else "0";
    m_axis_video_TVALID <= regslice_both_m_axis_video_V_data_V_U_vld_out;
    m_axis_video_TVALID_int_regslice <= grp_v_tpgHlsDataFlow_fu_442_m_axis_video_TVALID;
    select_ln505_fu_675_p3 <= 
        add_ln507_fu_669_p2 when (icmp_ln505_fu_663_p2(0) = '1') else 
        ap_const_lv32_0;
    tmp_1_fu_653_p4 <= s(31 downto 3);
end behav;
