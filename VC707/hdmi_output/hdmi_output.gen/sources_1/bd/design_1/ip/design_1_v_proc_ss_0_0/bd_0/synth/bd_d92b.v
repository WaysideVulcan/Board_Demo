...
module bd_d92b
  ...
  assign intf_net_bdry_in_s_axis_TDATA = s_axis_tdata[39:0];
  assign intf_net_bdry_in_s_axis_TDEST = s_axis_tdest[0];
  assign intf_net_bdry_in_s_axis_TID = s_axis_tid[0];
  assign intf_net_bdry_in_s_axis_TKEEP = s_axis_tkeep[4:0];
  assign intf_net_bdry_in_s_axis_TLAST = s_axis_tlast[0];
  assign intf_net_bdry_in_s_axis_TSTRB = s_axis_tstrb[4:0];
  ...
  assign m_axis_tdata[39:0] = intf_net_csc_m_axis_video_TDATA;
  assign m_axis_tdest[0] = intf_net_csc_m_axis_video_TDEST;
  assign m_axis_tid[0] = intf_net_csc_m_axis_video_TID;
  assign m_axis_tkeep[4:0] = intf_net_csc_m_axis_video_TKEEP;
  assign m_axis_tlast[0] = intf_net_csc_m_axis_video_TLAST;
  assign m_axis_tstrb[4:0] = intf_net_csc_m_axis_video_TSTRB;
