...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { boxColorR_val25 { I 12 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { boxColorR_val25_c_din { O 12 vector } boxColorR_val25_c_num_data_valid { I 3 vector } boxColorR_val25_c_fifo_cap { I 3 vector } boxColorR_val25_c_full_n { I 1 bit } boxColorR_val25_c_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { boxColorG_val26 { I 12 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { boxColorG_val26_c_din { O 12 vector } boxColorG_val26_c_num_data_valid { I 3 vector } boxColorG_val26_c_fifo_cap { I 3 vector } boxColorG_val26_c_full_n { I 1 bit } boxColorG_val26_c_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { boxColorB_val27 { I 12 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { boxColorB_val27_c_din { O 12 vector } boxColorB_val27_c_num_data_valid { I 3 vector } boxColorB_val27_c_fifo_cap { I 3 vector } boxColorB_val27_c_full_n { I 1 bit } boxColorB_val27_c_write { O 1 bit } } \
} "
}
