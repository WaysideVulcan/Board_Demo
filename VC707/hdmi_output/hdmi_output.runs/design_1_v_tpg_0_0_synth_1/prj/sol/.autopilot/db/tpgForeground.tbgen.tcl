...
set C_modelArgList {
	{ bckgndYUV int 36 regular {fifo 0 volatile }  }
	...
	{ boxColorR_val int 12 regular {fifo 0}  }
	{ boxColorG_val int 12 regular {fifo 0}  }
	{ boxColorB_val int 12 regular {fifo 0}  }
	{ motionSpeed_val int 8 regular {fifo 0}  }
	{ ovrlayYUV int 36 regular {fifo 1 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "bckgndYUV", "interface" : "fifo", "bitwidth" : 36, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "boxColorR_val", "interface" : "fifo", "bitwidth" : 12, "direction" : "READONLY"} , 
 	{ "Name" : "boxColorG_val", "interface" : "fifo", "bitwidth" : 12, "direction" : "READONLY"} , 
 	{ "Name" : "boxColorB_val", "interface" : "fifo", "bitwidth" : 12, "direction" : "READONLY"} , 
 	{ "Name" : "motionSpeed_val", "interface" : "fifo", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "ovrlayYUV", "interface" : "fifo", "bitwidth" : 36, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ bckgndYUV_dout sc_in sc_lv 36 signal 0 } 
	...
	{ boxColorR_val_dout sc_in sc_lv 12 signal 9 } 
	...
	{ boxColorG_val_dout sc_in sc_lv 12 signal 10 } 
	...
	{ boxColorB_val_dout sc_in sc_lv 12 signal 11 } 
	...
	{ ovrlayYUV_din sc_out sc_lv 36 signal 13 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "bckgndYUV_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":36, "type": "signal", "bundle":{"name": "bckgndYUV", "role": "dout" }} , 
 	...
 	{ "name": "boxColorR_val_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "boxColorR_val", "role": "dout" }} , 
 	...
 	{ "name": "boxColorG_val_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "boxColorG_val", "role": "dout" }} , 
 	...
 	{ "name": "boxColorB_val_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "boxColorB_val", "role": "dout" }} , 
 	...
 	{ "name": "ovrlayYUV_din", "direction": "out", "datatype": "sc_lv", "bitwidth":36, "type": "signal", "bundle":{"name": "ovrlayYUV", "role": "din" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "bckgndYUV", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "16", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_tpgForeground_Pipeline_VITIS_LOOP_774_2_fu_222", "Port" : "bckgndYUV", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			...
			{"Name" : "ovrlayYUV", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "16", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_tpgForeground_Pipeline_VITIS_LOOP_774_2_fu_222", "Port" : "ovrlayYUV", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			...
			{"Name" : "boxHCoord", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_tpgForeground_Pipeline_VITIS_LOOP_774_2_fu_222", "Port" : "boxHCoord", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			{"Name" : "boxVCoord", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_tpgForeground_Pipeline_VITIS_LOOP_774_2_fu_222", "Port" : "boxVCoord", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			{"Name" : "vDir", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_tpgForeground_Pipeline_VITIS_LOOP_774_2_fu_222", "Port" : "vDir", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			{"Name" : "hDir", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_tpgForeground_Pipeline_VITIS_LOOP_774_2_fu_222", "Port" : "hDir", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			{"Name" : "whiYuv_2", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_tpgForeground_Pipeline_VITIS_LOOP_774_2_fu_222", "Port" : "whiYuv_2", "Inst_start_state" : "3", "Inst_end_state" : "4"}]}],
		"Loop" : [
			{"Name" : "VITIS_LOOP_772_1", "PipelineType" : "no",
				"LoopDec" : {"FSMBitwidth" : "4", "FirstState" : "ap_ST_fsm_state2", "LastState" : ["ap_ST_fsm_state4"], "QuitState" : ["ap_ST_fsm_state2"], "PreState" : ["ap_ST_fsm_state1"], "PostState" : ["ap_ST_fsm_state1"], "OneDepthLoop" : "0", "OneStateBlock": ""}}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_tpgForeground_Pipeline_VITIS_LOOP_774_2_fu_222", "Parent" : "0", "Child" : ["2", "3"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_tpgForeground_Pipeline_VITIS_LOOP_774_2_fu_222.whiYuv_2_U", "Parent" : "1"},
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_tpgForeground_Pipeline_VITIS_LOOP_774_2_fu_222.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set Spec2ImplPortList { 
	bckgndYUV { ap_fifo {  { bckgndYUV_dout fifo_data_in 0 36 }  { bckgndYUV_num_data_valid fifo_status_num_data_valid 0 5 }  { bckgndYUV_fifo_cap fifo_update 0 5 }  { bckgndYUV_empty_n fifo_status 0 1 }  { bckgndYUV_read fifo_port_we 1 1 } } }
	...
	boxColorR_val { ap_fifo {  { boxColorR_val_dout fifo_data_in 0 12 }  { boxColorR_val_num_data_valid fifo_status_num_data_valid 0 3 }  { boxColorR_val_fifo_cap fifo_update 0 3 }  { boxColorR_val_empty_n fifo_status 0 1 }  { boxColorR_val_read fifo_port_we 1 1 } } }
	boxColorG_val { ap_fifo {  { boxColorG_val_dout fifo_data_in 0 12 }  { boxColorG_val_num_data_valid fifo_status_num_data_valid 0 3 }  { boxColorG_val_fifo_cap fifo_update 0 3 }  { boxColorG_val_empty_n fifo_status 0 1 }  { boxColorG_val_read fifo_port_we 1 1 } } }
	boxColorB_val { ap_fifo {  { boxColorB_val_dout fifo_data_in 0 12 }  { boxColorB_val_num_data_valid fifo_status_num_data_valid 0 3 }  { boxColorB_val_fifo_cap fifo_update 0 3 }  { boxColorB_val_empty_n fifo_status 0 1 }  { boxColorB_val_read fifo_port_we 1 1 } } }
	...
	ovrlayYUV { ap_fifo {  { ovrlayYUV_din fifo_data_in 1 36 }  { ovrlayYUV_num_data_valid fifo_status_num_data_valid 0 5 }  { ovrlayYUV_fifo_cap fifo_update 0 5 }  { ovrlayYUV_full_n fifo_status 0 1 }  { ovrlayYUV_write fifo_port_we 1 1 } } }
