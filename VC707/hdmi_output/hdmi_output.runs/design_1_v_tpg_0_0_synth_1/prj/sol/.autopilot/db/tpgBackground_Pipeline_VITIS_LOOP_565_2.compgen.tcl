...
set id 36
set name design_1_v_tpg_0_0_mac_muladd_12ns_7ns_17ns_19_4_1
set corename simcore_mac
set op mac
set stage_num 4
set clk_width 1
...
set ce_signed 0
set out_width 19
set arg_lists {i0 {12 0 +} i1 {7 0 +} m {19 1 +} i2 {17 0 +} p {19 0 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {all} IMPL {dsp_slice} LATENCY 3 ALLOW_PRAGMA 1
}
...
set id 37
set name design_1_v_tpg_0_0_mac_muladd_12ns_7s_20s_20_4_1
set corename simcore_mac
set op mac
set stage_num 4
set clk_width 1
...
set ce_signed 0
set out_width 20
set arg_lists {i0 {12 0 +} i1 {7 1 +} m {19 1 +} i2 {20 1 +} p {20 1 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {all} IMPL {dsp_slice} LATENCY 3 ALLOW_PRAGMA 1
}
...
set id 38
set name design_1_v_tpg_0_0_mac_muladd_12ns_8s_20s_20_4_1
set corename simcore_mac
set op mac
set stage_num 4
set clk_width 1
...
set ce_signed 0
set out_width 20
set arg_lists {i0 {12 0 +} i1 {8 1 +} m {20 1 +} i2 {20 1 +} p {20 0 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {all} IMPL {dsp_slice} LATENCY 3 ALLOW_PRAGMA 1
}
...
set id 39
set name design_1_v_tpg_0_0_mac_muladd_12ns_6s_19ns_20_4_1
set corename simcore_mac
set op mac
set stage_num 4
set clk_width 1
...
set ce_signed 0
set out_width 20
set arg_lists {i0 {12 0 +} i1 {6 1 +} m {18 1 +} i2 {19 0 +} p {20 1 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {all} IMPL {dsp_slice} LATENCY 3 ALLOW_PRAGMA 1
}
...
set id 40
set name design_1_v_tpg_0_0_mac_muladd_12ns_8ns_19ns_20_4_1
set corename simcore_mac
set op mac
set stage_num 4
set clk_width 1
...
set ce_signed 0
set out_width 20
set arg_lists {i0 {12 0 +} i1 {8 0 +} m {20 1 +} i2 {19 0 +} p {20 0 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {all} IMPL {dsp_slice} LATENCY 3 ALLOW_PRAGMA 1
}
...
set id 42
set name design_1_v_tpg_0_0_mac_muladd_12ns_5ns_20ns_21_4_1
set corename simcore_mac
set op mac
set stage_num 4
set clk_width 1
...
set ce_signed 0
set out_width 21
set arg_lists {i0 {12 0 +} i1 {5 0 +} m {17 0 +} i2 {20 0 +} p {21 0 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {all} IMPL {dsp_slice} LATENCY 3 ALLOW_PRAGMA 1
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { conv2_i_i_i266 { I 12 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { conv2_i_i_i248_cast_cast { I 9 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { conv2_i_i_i_cast_cast { I 5 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { conv2_i_i10_i264_cast_cast_cast_cast { I 7 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { conv2_i_i10_i246 { I 12 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { conv2_i_i10_i241 { I 12 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { bckgndYUV_din { O 36 vector } bckgndYUV_num_data_valid { I 5 vector } bckgndYUV_fifo_cap { I 5 vector } bckgndYUV_full_n { I 1 bit } bckgndYUV_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_cmp_i370 \
    op interface \
    ports { cmp_i370 { I 1 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { p_0_2_0_0_0217_out_i { I 12 vector } p_0_2_0_0_0217_out_o { O 12 vector } p_0_2_0_0_0217_out_o_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { p_0_1_0_0_0215_out_i { I 12 vector } p_0_1_0_0_0215_out_o { O 12 vector } p_0_1_0_0_0215_out_o_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { p_0_0_0_0_0213_out_i { I 12 vector } p_0_0_0_0_0213_out_o { O 12 vector } p_0_0_0_0_0213_out_o_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_rampVal \
    op interface \
    ports { rampVal { O 12 vector } rampVal_ap_vld { O 1 bit } } \
} "
}
