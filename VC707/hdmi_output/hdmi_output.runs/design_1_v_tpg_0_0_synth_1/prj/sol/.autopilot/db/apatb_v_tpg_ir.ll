; ModuleID = 'C:/Vulcan/Design_Tool/Board_Demo/VC707/hdmi_output/hdmi_output.runs/design_1_v_tpg_0_0_synth_1/prj/sol/.autopilot/db/a.g.ld.5.gdce.bc'
...
entry:
  ...
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<36>, 1, 1, 1, '8', false>, 0>"(i36* align 512 %_V_data_V, i5* align 512 %_V_keep_V, i5* align 512 %_V_strb_V, i1* align 512 %_V_user_V, i1* align 512 %_V_last_V, i1* align 512 %_V_id_V, i1* align 512 %_V_dest_V, %"class.hls::stream<hls::axis<ap_uint<36>, 1, 1, 1, '8', false>, 0>"* %44)
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<36>, 1, 1, 1, '8', false>, 0>"(i36* noalias align 512 "unpacked"="0.0" %dst_V_data_V, i5* noalias align 512 "unpacked"="0.1" %dst_V_keep_V, i5* noalias align 512 "unpacked"="0.2" %dst_V_strb_V, i1* noalias align 512 "unpacked"="0.3" %dst_V_user_V, i1* noalias align 512 "unpacked"="0.4" %dst_V_last_V, i1* noalias align 512 "unpacked"="0.5" %dst_V_id_V, i1* noalias align 512 "unpacked"="0.6" %dst_V_dest_V, %"class.hls::stream<hls::axis<ap_uint<36>, 1, 1, 1, '8', false>, 0>"* noalias %src) unnamed_addr #3 {
entry:
  %0 = icmp eq %"class.hls::stream<hls::axis<ap_uint<36>, 1, 1, 1, '8', false>, 0>"* %src, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<36>, 1, 1, 1, '8', false>, 0>"(i36* align 512 %dst_V_data_V, i5* align 512 %dst_V_keep_V, i5* align 512 %dst_V_strb_V, i1* align 512 %dst_V_user_V, i1* align 512 %dst_V_last_V, i1* align 512 %dst_V_id_V, i1* align 512 %dst_V_dest_V, %"class.hls::stream<hls::axis<ap_uint<36>, 1, 1, 1, '8', false>, 0>"* nonnull %src)
  br label %ret
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<36>, 1, 1, 1, '8', false>, 0>"(i36* noalias nocapture align 512 "unpacked"="0.0" %_V_data_V, i5* noalias nocapture align 512 "unpacked"="0.1" %_V_keep_V, i5* noalias nocapture align 512 "unpacked"="0.2" %_V_strb_V, i1* noalias nocapture align 512 "unpacked"="0.3" %_V_user_V, i1* noalias nocapture align 512 "unpacked"="0.4" %_V_last_V, i1* noalias nocapture align 512 "unpacked"="0.5" %_V_id_V, i1* noalias nocapture align 512 "unpacked"="0.6" %_V_dest_V, %"class.hls::stream<hls::axis<ap_uint<36>, 1, 1, 1, '8', false>, 0>"* noalias nocapture) unnamed_addr #4 {
entry:
...
entry:
  ...
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<36>, 1, 1, 1, '8', false>, 0>.90"(%"class.hls::stream<hls::axis<ap_uint<36>, 1, 1, 1, '8', false>, 0>"* %44, i36* align 512 %_V_data_V, i5* align 512 %_V_keep_V, i5* align 512 %_V_strb_V, i1* align 512 %_V_user_V, i1* align 512 %_V_last_V, i1* align 512 %_V_id_V, i1* align 512 %_V_dest_V)
  call fastcc void @onebyonecpy_hls.p0i1(i1* %45, i1* align 512 %46)
  ret void
}

; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<36>, 1, 1, 1, '8', false>, 0>.90"(%"class.hls::stream<hls::axis<ap_uint<36>, 1, 1, 1, '8', false>, 0>"* noalias %dst, i36* noalias align 512 "unpacked"="1.0" %src_V_data_V, i5* noalias align 512 "unpacked"="1.1" %src_V_keep_V, i5* noalias align 512 "unpacked"="1.2" %src_V_strb_V, i1* noalias align 512 "unpacked"="1.3" %src_V_user_V, i1* noalias align 512 "unpacked"="1.4" %src_V_last_V, i1* noalias align 512 "unpacked"="1.5" %src_V_id_V, i1* noalias align 512 "unpacked"="1.6" %src_V_dest_V) unnamed_addr #3 {
entry:
  %0 = icmp eq %"class.hls::stream<hls::axis<ap_uint<36>, 1, 1, 1, '8', false>, 0>"* %dst, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<36>, 1, 1, 1, '8', false>, 0>.93"(%"class.hls::stream<hls::axis<ap_uint<36>, 1, 1, 1, '8', false>, 0>"* nonnull %dst, i36* align 512 %src_V_data_V, i5* align 512 %src_V_keep_V, i5* align 512 %src_V_strb_V, i1* align 512 %src_V_user_V, i1* align 512 %src_V_last_V, i1* align 512 %src_V_id_V, i1* align 512 %src_V_dest_V)
  br label %ret
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<36>, 1, 1, 1, '8', false>, 0>.93"(%"class.hls::stream<hls::axis<ap_uint<36>, 1, 1, 1, '8', false>, 0>"* noalias nocapture, i36* noalias nocapture align 512 "unpacked"="1.0" %_V_data_V, i5* noalias nocapture align 512 "unpacked"="1.1" %_V_keep_V, i5* noalias nocapture align 512 "unpacked"="1.2" %_V_strb_V, i1* noalias nocapture align 512 "unpacked"="1.3" %_V_user_V, i1* noalias nocapture align 512 "unpacked"="1.4" %_V_last_V, i1* noalias nocapture align 512 "unpacked"="1.5" %_V_id_V, i1* noalias nocapture align 512 "unpacked"="1.6" %_V_dest_V) unnamed_addr #4 {
entry:
  %1 = alloca i36
  %2 = alloca i5
  %3 = alloca i5
...
declare void @apatb_v_tpg_hw(i16*, i16*, i16*, i1*, i8*, i8*, i8*, i8*, i8*, i16*, i16*, i16*, i16*, i16*, i16*, i16*, i16*, i16*, i16*, i8*, i8*, i16*, i36*, i5*, i5*, i1*, i1*, i1*, i1*, i1*)
...
define void @v_tpg_hw_stub_wrapper(i16*, i16*, i16*, i1*, i8*, i8*, i8*, i8*, i8*, i16*, i16*, i16*, i16*, i16*, i16*, i16*, i16*, i16*, i16*, i8*, i8*, i16*, i36*, i5*, i5*, i1*, i1*, i1*, i1*, i1*) #6 {
entry:
  %30 = alloca %"class.hls::stream<hls::axis<ap_uint<36>, 1, 1, 1, '8', false>, 0>"
  call void @copy_out(i16* null, i16* %0, i16* null, i16* %1, i16* null, i16* %2, i1* null, i1* %3, i8* null, i8* %4, i8* null, i8* %5, i8* null, i8* %6, i8* null, i8* %7, i8* null, i8* %8, i16* null, i16* %9, i16* null, i16* %10, i16* null, i16* %11, i16* null, i16* %12, i16* null, i16* %13, i16* null, i16* %14, i16* null, i16* %15, i16* null, i16* %16, i16* null, i16* %17, i16* null, i16* %18, i8* null, i8* %19, i8* null, i8* %20, i16* null, i16* %21, %"class.hls::stream<hls::axis<ap_uint<36>, 1, 1, 1, '8', false>, 0>"* %30, i36* %22, i5* %23, i5* %24, i1* %25, i1* %26, i1* %27, i1* %28, i1* null, i1* %29)
  call void @v_tpg_hw_stub(i16* %0, i16* %1, i16* %2, i1* %3, i8* %4, i8* %5, i8* %6, i8* %7, i8* %8, i16* %9, i16* %10, i16* %11, i16* %12, i16* %13, i16* %14, i16* %15, i16* %16, i16* %17, i16* %18, i8* %19, i8* %20, i16* %21, %"class.hls::stream<hls::axis<ap_uint<36>, 1, 1, 1, '8', false>, 0>"* %30, i1* %29)
...
declare void @v_tpg_hw_stub(i16*, i16*, i16*, i1*, i8*, i8*, i8*, i8*, i8*, i16*, i16*, i16*, i16*, i16*, i16*, i16*, i16*, i16*, i16*, i8*, i8*, i16*, %"class.hls::stream<hls::axis<ap_uint<36>, 1, 1, 1, '8', false>, 0>"*, i1*)
