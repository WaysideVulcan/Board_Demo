...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { bckgndYUV_dout { I 36 vector } bckgndYUV_num_data_valid { I 5 vector } bckgndYUV_fifo_cap { I 5 vector } bckgndYUV_empty_n { I 1 bit } bckgndYUV_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { boxColorR_val_dout { I 12 vector } boxColorR_val_num_data_valid { I 3 vector } boxColorR_val_fifo_cap { I 3 vector } boxColorR_val_empty_n { I 1 bit } boxColorR_val_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { boxColorG_val_dout { I 12 vector } boxColorG_val_num_data_valid { I 3 vector } boxColorG_val_fifo_cap { I 3 vector } boxColorG_val_empty_n { I 1 bit } boxColorG_val_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { boxColorB_val_dout { I 12 vector } boxColorB_val_num_data_valid { I 3 vector } boxColorB_val_fifo_cap { I 3 vector } boxColorB_val_empty_n { I 1 bit } boxColorB_val_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { ovrlayYUV_din { O 36 vector } ovrlayYUV_num_data_valid { I 5 vector } ovrlayYUV_fifo_cap { I 5 vector } ovrlayYUV_full_n { I 1 bit } ovrlayYUV_write { O 1 bit } } \
} "
}
