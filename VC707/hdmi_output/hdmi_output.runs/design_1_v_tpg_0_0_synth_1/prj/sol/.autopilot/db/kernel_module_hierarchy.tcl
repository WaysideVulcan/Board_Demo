...
"SubInsts" : [
	{"Name" : "grp_v_tpgHlsDataFlow_fu_443","ID" : "1","Type" : "dataflow",
		...
		{"Name" : "tpgBackground_U0","ID" : "2","Type" : "sequential",
			...
			"SubInsts" : [
			{"Name" : "grp_tpgBackground_Pipeline_VITIS_LOOP_565_2_fu_490","ID" : "4","Type" : "sequential",
					"SubLoops" : [
					{"Name" : "VITIS_LOOP_565_2","ID" : "5","Type" : "pipeline",
					"SubInsts" : [
					{"Name" : "grp_reg_ap_uint_10_s_fu_1717","ID" : "6","Type" : "pipeline"},
					{"Name" : "grp_reg_int_s_fu_2146","ID" : "7","Type" : "pipeline"},]},]},]},]},
		{"Name" : "entry_proc_U0","ID" : "8","Type" : "sequential"},
		{"Name" : "tpgForeground_U0","ID" : "9","Type" : "sequential",
			"SubLoops" : [
			{"Name" : "VITIS_LOOP_772_1","ID" : "10","Type" : "no",
			"SubInsts" : [
			{"Name" : "grp_tpgForeground_Pipeline_VITIS_LOOP_774_2_fu_222","ID" : "11","Type" : "sequential",
					"SubLoops" : [
