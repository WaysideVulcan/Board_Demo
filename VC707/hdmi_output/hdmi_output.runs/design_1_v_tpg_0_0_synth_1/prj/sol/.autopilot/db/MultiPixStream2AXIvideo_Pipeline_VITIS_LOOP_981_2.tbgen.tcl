...
set C_modelArgList {
	...
	{ ovrlayYUV int 36 regular {fifo 0 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "sof", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "ovrlayYUV", "interface" : "fifo", "bitwidth" : 36, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ ovrlayYUV_dout sc_in sc_lv 36 signal 5 } 
	...
	{ m_axis_video_TDATA sc_out sc_lv 40 signal 7 } 
	{ m_axis_video_TVALID sc_out sc_logic 1 outvld 13 } 
	{ m_axis_video_TREADY sc_in sc_logic 1 outacc 7 } 
	{ m_axis_video_TKEEP sc_out sc_lv 5 signal 8 } 
	{ m_axis_video_TSTRB sc_out sc_lv 5 signal 9 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "ovrlayYUV_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":36, "type": "signal", "bundle":{"name": "ovrlayYUV", "role": "dout" }} , 
...
set Spec2ImplPortList { 
	...
	ovrlayYUV { ap_fifo {  { ovrlayYUV_dout fifo_data_in 0 36 }  { ovrlayYUV_num_data_valid fifo_status_num_data_valid 0 5 }  { ovrlayYUV_fifo_cap fifo_update 0 5 }  { ovrlayYUV_empty_n fifo_status 0 1 }  { ovrlayYUV_read fifo_port_we 1 1 } } }
	colorFormat_val17_load { ap_none {  { colorFormat_val17_load in_data 0 8 } } }
	m_axis_video_V_data_V { axis {  { m_axis_video_TDATA out_data 1 40 }  { m_axis_video_TREADY out_acc 0 1 } } }
