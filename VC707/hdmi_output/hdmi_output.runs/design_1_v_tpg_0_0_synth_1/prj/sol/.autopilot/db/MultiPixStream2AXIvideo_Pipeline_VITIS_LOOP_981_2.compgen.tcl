...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { m_axis_video_TDATA { O 40 vector } m_axis_video_TREADY { I 1 bit } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { ovrlayYUV_dout { I 36 vector } ovrlayYUV_num_data_valid { I 5 vector } ovrlayYUV_fifo_cap { I 5 vector } ovrlayYUV_empty_n { I 1 bit } ovrlayYUV_read { O 1 bit } } \
} "
}
