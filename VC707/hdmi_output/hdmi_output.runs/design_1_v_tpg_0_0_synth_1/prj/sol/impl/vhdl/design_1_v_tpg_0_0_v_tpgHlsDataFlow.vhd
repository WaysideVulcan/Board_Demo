...
port (
    ...
    boxColorR_val25 : IN STD_LOGIC_VECTOR (11 downto 0);
    boxColorG_val26 : IN STD_LOGIC_VECTOR (11 downto 0);
    boxColorB_val27 : IN STD_LOGIC_VECTOR (11 downto 0);
...
attribute shreg_extract : string;
    ...
    signal entry_proc_U0_boxColorR_val25_c_din : STD_LOGIC_VECTOR (11 downto 0);
    signal entry_proc_U0_boxColorR_val25_c_write : STD_LOGIC;
    signal entry_proc_U0_boxColorG_val26_c_din : STD_LOGIC_VECTOR (11 downto 0);
    signal entry_proc_U0_boxColorG_val26_c_write : STD_LOGIC;
    signal entry_proc_U0_boxColorB_val27_c_din : STD_LOGIC_VECTOR (11 downto 0);
    ...
    port (
        ...
        boxColorR_val25 : IN STD_LOGIC_VECTOR (11 downto 0);
        boxColorR_val25_c_din : OUT STD_LOGIC_VECTOR (11 downto 0);
        ...
        boxColorG_val26 : IN STD_LOGIC_VECTOR (11 downto 0);
        boxColorG_val26_c_din : OUT STD_LOGIC_VECTOR (11 downto 0);
        ...
        boxColorB_val27 : IN STD_LOGIC_VECTOR (11 downto 0);
        boxColorB_val27_c_din : OUT STD_LOGIC_VECTOR (11 downto 0);
    ...
    component design_1_v_tpg_0_0_fifo_w12_d3_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component design_1_v_tpg_0_0_fifo_w36_d16_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    ...
    boxColorR_val25_c_U : component design_1_v_tpg_0_0_fifo_w12_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    boxColorG_val26_c_U : component design_1_v_tpg_0_0_fifo_w12_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    boxColorB_val27_c_U : component design_1_v_tpg_0_0_fifo_w12_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    bckgndYUV_U : component design_1_v_tpg_0_0_fifo_w36_d16_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    height_val4_c12_U : component design_1_v_tpg_0_0_fifo_w16_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    width_val7_c13_U : component design_1_v_tpg_0_0_fifo_w16_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    colorFormat_val17_c14_U : component design_1_v_tpg_0_0_fifo_w8_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ovrlayYUV_U : component design_1_v_tpg_0_0_fifo_w36_d16_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
