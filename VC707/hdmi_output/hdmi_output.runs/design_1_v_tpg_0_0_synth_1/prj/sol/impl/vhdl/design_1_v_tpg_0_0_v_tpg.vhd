...
architecture behav of design_1_v_tpg_0_0_v_tpg is 
    ...
    "design_1_v_tpg_0_0_v_tpg,hls_ip_2023_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7vx485t-ffg1761-2,HLS_INPUT_CLOCK=6.737000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=4.782000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=13,HLS_SYN_DSP=0,HLS_SYN_FF=7859,HLS_SYN_LUT=9436,HLS_VERSION=2023_2}";
    ...
    signal empty_fu_714_p1 : STD_LOGIC_VECTOR (11 downto 0);
    signal empty_reg_821 : STD_LOGIC_VECTOR (11 downto 0);
    signal empty_89_fu_719_p1 : STD_LOGIC_VECTOR (11 downto 0);
    signal empty_89_reg_826 : STD_LOGIC_VECTOR (11 downto 0);
    signal empty_90_fu_724_p1 : STD_LOGIC_VECTOR (11 downto 0);
    ...
    signal grp_v_tpgHlsDataFlow_fu_443_m_axis_video_TDATA : STD_LOGIC_VECTOR (39 downto 0);
    signal grp_v_tpgHlsDataFlow_fu_443_m_axis_video_TKEEP : STD_LOGIC_VECTOR (4 downto 0);
    signal grp_v_tpgHlsDataFlow_fu_443_m_axis_video_TSTRB : STD_LOGIC_VECTOR (4 downto 0);
...
begin
    grp_v_tpgHlsDataFlow_fu_443 : component design_1_v_tpg_0_0_v_tpgHlsDataFlow
    port map (
        ...
        boxColorG_val26 => empty_89_reg_826,
        boxColorB_val27 => empty_90_reg_831,
    ...
    grp_reg_unsigned_short_s_fu_640 : component design_1_v_tpg_0_0_reg_unsigned_short_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        d => bck_motion_en,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state3)) then
                ...
                empty_89_reg_826 <= empty_89_fu_719_p1;
                empty_90_reg_831 <= empty_90_fu_724_p1;
    ...
    empty_89_fu_719_p1 <= boxColorG(12 - 1 downto 0);
    empty_90_fu_724_p1 <= boxColorB(12 - 1 downto 0);
    empty_fu_714_p1 <= boxColorR(12 - 1 downto 0);
    fid <= grp_v_tpgHlsDataFlow_fu_443_fid;
