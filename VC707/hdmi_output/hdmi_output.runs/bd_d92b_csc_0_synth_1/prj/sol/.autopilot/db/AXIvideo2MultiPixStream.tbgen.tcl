...
set C_modelArgList {
	...
	{ stream_in int 36 regular {fifo 1 volatile }  }
	{ p_read int 12 regular  }
	{ p_read1 int 12 regular  }
	{ p_read2 int 8 regular  }
	{ HwReg_width_c11 int 12 regular {fifo 1}  }
	{ HwReg_height_c13 int 12 regular {fifo 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "s_axis_video_V_data_V", "interface" : "axis", "bitwidth" : 40, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "stream_in", "interface" : "fifo", "bitwidth" : 36, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "HwReg_width_c11", "interface" : "fifo", "bitwidth" : 12, "direction" : "WRITEONLY"} , 
 	{ "Name" : "HwReg_height_c13", "interface" : "fifo", "bitwidth" : 12, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ stream_in_din sc_out sc_lv 36 signal 7 } 
	...
	{ HwReg_width_c11_din sc_out sc_lv 12 signal 11 } 
	{ HwReg_width_c11_num_data_valid sc_in sc_lv 3 signal 11 } 
	{ HwReg_width_c11_fifo_cap sc_in sc_lv 3 signal 11 } 
	{ HwReg_width_c11_full_n sc_in sc_logic 1 signal 11 } 
	{ HwReg_width_c11_write sc_out sc_logic 1 signal 11 } 
	{ HwReg_height_c13_din sc_out sc_lv 12 signal 12 } 
	{ HwReg_height_c13_num_data_valid sc_in sc_lv 3 signal 12 } 
	{ HwReg_height_c13_fifo_cap sc_in sc_lv 3 signal 12 } 
	{ HwReg_height_c13_full_n sc_in sc_logic 1 signal 12 } 
	{ HwReg_height_c13_write sc_out sc_logic 1 signal 12 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "stream_in_din", "direction": "out", "datatype": "sc_lv", "bitwidth":36, "type": "signal", "bundle":{"name": "stream_in", "role": "din" }} , 
 	...
 	{ "name": "HwReg_width_c11_din", "direction": "out", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "HwReg_width_c11", "role": "din" }} , 
 	{ "name": "HwReg_width_c11_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "HwReg_width_c11", "role": "num_data_valid" }} , 
 	{ "name": "HwReg_width_c11_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "HwReg_width_c11", "role": "fifo_cap" }} , 
 	{ "name": "HwReg_width_c11_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "HwReg_width_c11", "role": "full_n" }} , 
 	{ "name": "HwReg_width_c11_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "HwReg_width_c11", "role": "write" }} , 
 	{ "name": "HwReg_height_c13_din", "direction": "out", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "HwReg_height_c13", "role": "din" }} , 
 	{ "name": "HwReg_height_c13_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "HwReg_height_c13", "role": "num_data_valid" }} , 
 	{ "name": "HwReg_height_c13_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "HwReg_height_c13", "role": "fifo_cap" }} , 
 	{ "name": "HwReg_height_c13_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "HwReg_height_c13", "role": "full_n" }} , 
 	{ "name": "HwReg_height_c13_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "HwReg_height_c13", "role": "write" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "3", "5", "7", "8", "9", "10", "11", "12", "13", "14", "15"],
		...
		"Port" : [
			...
			{"Name" : "HwReg_width_c11", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "HwReg_width_c11_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "HwReg_height_c13", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	...
	stream_in { ap_fifo {  { stream_in_din fifo_data_in 1 36 }  { stream_in_num_data_valid fifo_status_num_data_valid 0 5 }  { stream_in_fifo_cap fifo_update 0 5 }  { stream_in_full_n fifo_status 0 1 }  { stream_in_write fifo_port_we 1 1 } } }
	p_read { ap_none {  { p_read in_data 0 12 } } }
	p_read1 { ap_none {  { p_read1 in_data 0 12 } } }
	p_read2 { ap_none {  { p_read2 in_data 0 8 } } }
	HwReg_width_c11 { ap_fifo {  { HwReg_width_c11_din fifo_data_in 1 12 }  { HwReg_width_c11_num_data_valid fifo_status_num_data_valid 0 3 }  { HwReg_width_c11_fifo_cap fifo_update 0 3 }  { HwReg_width_c11_full_n fifo_status 0 1 }  { HwReg_width_c11_write fifo_port_we 1 1 } } }
	HwReg_height_c13 { ap_fifo {  { HwReg_height_c13_din fifo_data_in 1 12 }  { HwReg_height_c13_num_data_valid fifo_status_num_data_valid 0 3 }  { HwReg_height_c13_fifo_cap fifo_update 0 3 }  { HwReg_height_c13_full_n fifo_status 0 1 }  { HwReg_height_c13_write fifo_port_we 1 1 } } }
}
