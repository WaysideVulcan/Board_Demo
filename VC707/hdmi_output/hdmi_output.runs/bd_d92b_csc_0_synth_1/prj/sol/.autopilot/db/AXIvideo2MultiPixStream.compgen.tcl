...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { stream_in_din { O 36 vector } stream_in_num_data_valid { I 5 vector } stream_in_fifo_cap { I 5 vector } stream_in_full_n { I 1 bit } stream_in_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 83 \
    name HwReg_width_c11 \
    type fifo \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_HwReg_width_c11 \
    op interface \
    ports { HwReg_width_c11_din { O 12 vector } HwReg_width_c11_num_data_valid { I 3 vector } HwReg_width_c11_fifo_cap { I 3 vector } HwReg_width_c11_full_n { I 1 bit } HwReg_width_c11_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 84 \
    name HwReg_height_c13 \
    type fifo \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_HwReg_height_c13 \
    op interface \
    ports { HwReg_height_c13_din { O 12 vector } HwReg_height_c13_num_data_valid { I 3 vector } HwReg_height_c13_fifo_cap { I 3 vector } HwReg_height_c13_full_n { I 1 bit } HwReg_height_c13_write { O 1 bit } } \
} "
}
...
# RegSlice definition:
set ID 85
set RegSliceName bd_d92b_csc_0_regslice_both
set RegSliceInstName bd_d92b_csc_0_regslice_both_U
set CoreName ap_simcore_bd_d92b_csc_0_regslice_both
