...
set C_modelArgList {
	{ stream_csc int 36 regular {fifo 0 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "stream_csc", "interface" : "fifo", "bitwidth" : 36, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ stream_csc_dout sc_in sc_lv 36 signal 0 } 
	...
	{ m_axis_video_TDATA sc_out sc_lv 40 signal 1 } 
	{ m_axis_video_TVALID sc_out sc_logic 1 outvld 7 } 
	{ m_axis_video_TREADY sc_in sc_logic 1 outacc 7 } 
	{ m_axis_video_TKEEP sc_out sc_lv 5 signal 2 } 
	{ m_axis_video_TSTRB sc_out sc_lv 5 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "stream_csc_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":36, "type": "signal", "bundle":{"name": "stream_csc", "role": "dout" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "4483", "Max" : "8307363"}
	, {"Name" : "Interval", "Min" : "4483", "Max" : "8307363"}
]}
...
set Spec2ImplPortList { 
	stream_csc { ap_fifo {  { stream_csc_dout fifo_data_in 0 36 }  { stream_csc_num_data_valid fifo_status_num_data_valid 0 5 }  { stream_csc_fifo_cap fifo_update 0 5 }  { stream_csc_empty_n fifo_status 0 1 }  { stream_csc_read fifo_port_we 1 1 } } }
	...
	WidthOut { ap_fifo {  { WidthOut_dout fifo_data_in 0 12 }  { WidthOut_num_data_valid fifo_status_num_data_valid 0 3 }  { WidthOut_fifo_cap fifo_update 0 3 }  { WidthOut_empty_n fifo_status 0 1 }  { WidthOut_read fifo_port_we 1 1 } } }
