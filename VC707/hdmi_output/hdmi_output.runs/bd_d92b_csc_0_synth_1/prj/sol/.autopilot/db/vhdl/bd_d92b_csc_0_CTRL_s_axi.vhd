...
port (
    ...
    ROffset               :out  STD_LOGIC_VECTOR(13 downto 0);
    GOffset               :out  STD_LOGIC_VECTOR(13 downto 0);
    BOffset               :out  STD_LOGIC_VECTOR(13 downto 0);
    ClampMin              :out  STD_LOGIC_VECTOR(11 downto 0);
    ClipMax               :out  STD_LOGIC_VECTOR(11 downto 0);
    ...
    ROffset_2             :out  STD_LOGIC_VECTOR(13 downto 0);
    GOffset_2             :out  STD_LOGIC_VECTOR(13 downto 0);
    BOffset_2             :out  STD_LOGIC_VECTOR(13 downto 0);
    ClampMin_2            :out  STD_LOGIC_VECTOR(11 downto 0);
    ClipMax_2             :out  STD_LOGIC_VECTOR(11 downto 0);
...
--         bit 13~0 - ROffset[13:0] (Read/Write)
--         others   - reserved
-- 0x09c : reserved
-- 0x0a0 : Data signal of GOffset
--         bit 13~0 - GOffset[13:0] (Read/Write)
--         others   - reserved
-- 0x0a4 : reserved
-- 0x0a8 : Data signal of BOffset
--         bit 13~0 - BOffset[13:0] (Read/Write)
--         others   - reserved
-- 0x0ac : reserved
-- 0x0b0 : Data signal of ClampMin
--         bit 11~0 - ClampMin[11:0] (Read/Write)
--         others   - reserved
-- 0x0b4 : reserved
-- 0x0b8 : Data signal of ClipMax
--         bit 11~0 - ClipMax[11:0] (Read/Write)
--         others   - reserved
-- 0x0bc : reserved
...
--         bit 13~0 - ROffset_2[13:0] (Read/Write)
--         others   - reserved
-- 0x10c : reserved
-- 0x110 : Data signal of GOffset_2
--         bit 13~0 - GOffset_2[13:0] (Read/Write)
--         others   - reserved
-- 0x114 : reserved
-- 0x118 : Data signal of BOffset_2
--         bit 13~0 - BOffset_2[13:0] (Read/Write)
--         others   - reserved
-- 0x11c : reserved
-- 0x120 : Data signal of ClampMin_2
--         bit 11~0 - ClampMin_2[11:0] (Read/Write)
--         others   - reserved
-- 0x124 : reserved
-- 0x128 : Data signal of ClipMax_2
--         bit 11~0 - ClipMax_2[11:0] (Read/Write)
--         others   - reserved
-- 0x12c : reserved
...
architecture behave of bd_d92b_csc_0_CTRL_s_axi is
    ...
    signal int_ROffset         : UNSIGNED(13 downto 0) := (others => '0');
    signal int_GOffset         : UNSIGNED(13 downto 0) := (others => '0');
    signal int_BOffset         : UNSIGNED(13 downto 0) := (others => '0');
    signal int_ClampMin        : UNSIGNED(11 downto 0) := (others => '0');
    signal int_ClipMax         : UNSIGNED(11 downto 0) := (others => '0');
    ...
    signal int_ROffset_2       : UNSIGNED(13 downto 0) := (others => '0');
    signal int_GOffset_2       : UNSIGNED(13 downto 0) := (others => '0');
    signal int_BOffset_2       : UNSIGNED(13 downto 0) := (others => '0');
    signal int_ClampMin_2      : UNSIGNED(11 downto 0) := (others => '0');
    signal int_ClipMax_2       : UNSIGNED(11 downto 0) := (others => '0');
            ...
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_ROFFSET_DATA_0 =>
                        rdata_data <= RESIZE(int_ROffset(13 downto 0), 32);
                    when ADDR_GOFFSET_DATA_0 =>
                        rdata_data <= RESIZE(int_GOffset(13 downto 0), 32);
                    when ADDR_BOFFSET_DATA_0 =>
                        rdata_data <= RESIZE(int_BOffset(13 downto 0), 32);
                    when ADDR_CLAMPMIN_DATA_0 =>
                        rdata_data <= RESIZE(int_ClampMin(11 downto 0), 32);
                    when ADDR_CLIPMAX_DATA_0 =>
                        rdata_data <= RESIZE(int_ClipMax(11 downto 0), 32);
                    ...
                    when ADDR_ROFFSET_2_DATA_0 =>
                        rdata_data <= RESIZE(int_ROffset_2(13 downto 0), 32);
                    when ADDR_GOFFSET_2_DATA_0 =>
                        rdata_data <= RESIZE(int_GOffset_2(13 downto 0), 32);
                    when ADDR_BOFFSET_2_DATA_0 =>
                        rdata_data <= RESIZE(int_BOffset_2(13 downto 0), 32);
                    when ADDR_CLAMPMIN_2_DATA_0 =>
                        rdata_data <= RESIZE(int_ClampMin_2(11 downto 0), 32);
                    when ADDR_CLIPMAX_2_DATA_0 =>
                        rdata_data <= RESIZE(int_ClipMax_2(11 downto 0), 32);
                    when others =>
                        NULL;
                    end case;
                end if;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_ROFFSET_DATA_0) then
                    int_ROffset(13 downto 0) <= (UNSIGNED(WDATA(13 downto 0)) and wmask(13 downto 0)) or ((not wmask(13 downto 0)) and int_ROffset(13 downto 0));
                end if;
            end if;
        end if;
    end process;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_GOFFSET_DATA_0) then
                    int_GOffset(13 downto 0) <= (UNSIGNED(WDATA(13 downto 0)) and wmask(13 downto 0)) or ((not wmask(13 downto 0)) and int_GOffset(13 downto 0));
                end if;
            end if;
        end if;
    end process;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_BOFFSET_DATA_0) then
                    int_BOffset(13 downto 0) <= (UNSIGNED(WDATA(13 downto 0)) and wmask(13 downto 0)) or ((not wmask(13 downto 0)) and int_BOffset(13 downto 0));
                end if;
            end if;
        end if;
    end process;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_CLAMPMIN_DATA_0) then
                    int_ClampMin(11 downto 0) <= (UNSIGNED(WDATA(11 downto 0)) and wmask(11 downto 0)) or ((not wmask(11 downto 0)) and int_ClampMin(11 downto 0));
                end if;
            end if;
        end if;
    end process;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_CLIPMAX_DATA_0) then
                    int_ClipMax(11 downto 0) <= (UNSIGNED(WDATA(11 downto 0)) and wmask(11 downto 0)) or ((not wmask(11 downto 0)) and int_ClipMax(11 downto 0));
                end if;
            end if;
        end if;
    end process;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_ROFFSET_2_DATA_0) then
                    int_ROffset_2(13 downto 0) <= (UNSIGNED(WDATA(13 downto 0)) and wmask(13 downto 0)) or ((not wmask(13 downto 0)) and int_ROffset_2(13 downto 0));
                end if;
            end if;
        end if;
    end process;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_GOFFSET_2_DATA_0) then
                    int_GOffset_2(13 downto 0) <= (UNSIGNED(WDATA(13 downto 0)) and wmask(13 downto 0)) or ((not wmask(13 downto 0)) and int_GOffset_2(13 downto 0));
                end if;
            end if;
        end if;
    end process;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_BOFFSET_2_DATA_0) then
                    int_BOffset_2(13 downto 0) <= (UNSIGNED(WDATA(13 downto 0)) and wmask(13 downto 0)) or ((not wmask(13 downto 0)) and int_BOffset_2(13 downto 0));
                end if;
            end if;
        end if;
    end process;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_CLAMPMIN_2_DATA_0) then
                    int_ClampMin_2(11 downto 0) <= (UNSIGNED(WDATA(11 downto 0)) and wmask(11 downto 0)) or ((not wmask(11 downto 0)) and int_ClampMin_2(11 downto 0));
                end if;
            end if;
        end if;
    end process;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_CLIPMAX_2_DATA_0) then
                    int_ClipMax_2(11 downto 0) <= (UNSIGNED(WDATA(11 downto 0)) and wmask(11 downto 0)) or ((not wmask(11 downto 0)) and int_ClipMax_2(11 downto 0));
                end if;
            end if;
        end if;
    end process;
