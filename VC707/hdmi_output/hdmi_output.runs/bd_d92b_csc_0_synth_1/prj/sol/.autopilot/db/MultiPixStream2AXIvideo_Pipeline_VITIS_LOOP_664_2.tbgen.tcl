...
set portList { 
	...
	{ stream_csc_dout sc_in sc_lv 36 signal 11 } 
	{ stream_csc_num_data_valid sc_in sc_lv 5 signal 11 } 
	{ stream_csc_fifo_cap sc_in sc_lv 5 signal 11 } 
	{ stream_csc_empty_n sc_in sc_logic 1 signal 11 } 
	{ stream_csc_read sc_out sc_logic 1 signal 11 } 
	{ m_axis_video_TREADY sc_in sc_logic 1 outacc 2 } 
	{ sof sc_in sc_lv 1 signal 0 } 
	{ cols sc_in sc_lv 12 signal 1 } 
	{ m_axis_video_TDATA sc_out sc_lv 40 signal 2 } 
	{ m_axis_video_TVALID sc_out sc_logic 1 outvld 8 } 
	{ m_axis_video_TKEEP sc_out sc_lv 5 signal 3 } 
	{ m_axis_video_TSTRB sc_out sc_lv 5 signal 4 } 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "68", "Max" : "3844"}
	, {"Name" : "Interval", "Min" : "68", "Max" : "3844"}
]}
...
set Spec2ImplPortList { 
	...
	m_axis_video_V_data_V { axis {  { m_axis_video_TREADY out_acc 0 1 }  { m_axis_video_TDATA out_data 1 40 } } }
