...
attribute shreg_extract : string;
    ...
    signal add_ln134_fu_393_p2 : STD_LOGIC_VECTOR (12 downto 0);
    signal add_ln134_reg_616 : STD_LOGIC_VECTOR (12 downto 0);
    signal add_ln134_1_fu_403_p2 : STD_LOGIC_VECTOR (12 downto 0);
    signal add_ln134_1_reg_621 : STD_LOGIC_VECTOR (12 downto 0);
    ...
    signal grp_v_csc_core_Pipeline_VITIS_LOOP_136_2_fu_348_ap_start : STD_LOGIC;
    signal grp_v_csc_core_Pipeline_VITIS_LOOP_136_2_fu_348_ap_done : STD_LOGIC;
    signal grp_v_csc_core_Pipeline_VITIS_LOOP_136_2_fu_348_ap_idle : STD_LOGIC;
    signal grp_v_csc_core_Pipeline_VITIS_LOOP_136_2_fu_348_ap_ready : STD_LOGIC;
    signal grp_v_csc_core_Pipeline_VITIS_LOOP_136_2_fu_348_stream_in_read : STD_LOGIC;
    signal grp_v_csc_core_Pipeline_VITIS_LOOP_136_2_fu_348_stream_csc_din : STD_LOGIC_VECTOR (35 downto 0);
    signal grp_v_csc_core_Pipeline_VITIS_LOOP_136_2_fu_348_stream_csc_write : STD_LOGIC;
    signal grp_v_csc_core_Pipeline_VITIS_LOOP_136_2_fu_348_ap_start_reg : STD_LOGIC := '0';
    signal icmp_ln134_fu_417_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal y_fu_124 : STD_LOGIC_VECTOR (12 downto 0) := "0000000000000";
    signal y_3_fu_438_p2 : STD_LOGIC_VECTOR (12 downto 0);
    ...
    signal zext_ln134_fu_422_p1 : STD_LOGIC_VECTOR (15 downto 0);
...
begin
    grp_v_csc_core_Pipeline_VITIS_LOOP_136_2_fu_348 : component bd_d92b_csc_0_v_csc_core_Pipeline_VITIS_LOOP_136_2
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((icmp_ln134_fu_417_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    grp_v_csc_core_Pipeline_VITIS_LOOP_136_2_fu_348_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                grp_v_csc_core_Pipeline_VITIS_LOOP_136_2_fu_348_ap_start_reg <= ap_const_logic_0;
            else
                if (((icmp_ln134_fu_417_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
                    grp_v_csc_core_Pipeline_VITIS_LOOP_136_2_fu_348_ap_start_reg <= ap_const_logic_1;
                elsif ((grp_v_csc_core_Pipeline_VITIS_LOOP_136_2_fu_348_ap_ready = ap_const_logic_1)) then 
                    grp_v_csc_core_Pipeline_VITIS_LOOP_136_2_fu_348_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((icmp_ln134_fu_417_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    ap_NS_fsm_assign_proc : process (ap_CS_fsm, ap_CS_fsm_state1, ap_block_state1, ap_CS_fsm_state2, grp_v_csc_core_Pipeline_VITIS_LOOP_136_2_fu_348_ap_done, icmp_ln134_fu_417_p2, ap_CS_fsm_state3)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if (((icmp_ln134_fu_417_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_state3;
                end if;
            when ap_ST_fsm_state3 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state3) and (grp_v_csc_core_Pipeline_VITIS_LOOP_136_2_fu_348_ap_done = ap_const_logic_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state2;
                else
                    ap_NS_fsm <= ap_ST_fsm_state3;
                end if;
    ...
    HwReg_height_c_write_assign_proc : process(ap_CS_fsm_state1, ap_block_state1)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_const_boolean_0 = ap_block_state1))) then 
    ...
    add_ln134_1_fu_403_p2 <= std_logic_vector(unsigned(height_load_cast_fu_399_p1) + unsigned(ap_const_lv13_1));
    add_ln134_fu_393_p2 <= std_logic_vector(unsigned(loopWidth_cast_fu_389_p1) + unsigned(ap_const_lv13_1));
    ...
    ap_ST_fsm_state3_blk_assign_proc : process(grp_v_csc_core_Pipeline_VITIS_LOOP_136_2_fu_348_ap_done)
    begin
        if ((grp_v_csc_core_Pipeline_VITIS_LOOP_136_2_fu_348_ap_done = ap_const_logic_0)) then 
    ...
    ap_done_assign_proc : process(ap_done_reg, ap_CS_fsm_state2, icmp_ln134_fu_417_p2)
    begin
        if (((icmp_ln134_fu_417_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    ap_ready_assign_proc : process(ap_CS_fsm_state2, icmp_ln134_fu_417_p2)
    begin
        if (((icmp_ln134_fu_417_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    cmp17_not_fu_426_p2 <= "1" when (unsigned(zext_ln134_fu_422_p1) < unsigned(RowStart_read)) else "0";
    cmp20_not_fu_432_p2 <= "1" when (unsigned(zext_ln134_fu_422_p1) > unsigned(RowEnd_read)) else "0";
    grp_v_csc_core_Pipeline_VITIS_LOOP_136_2_fu_348_ap_start <= grp_v_csc_core_Pipeline_VITIS_LOOP_136_2_fu_348_ap_start_reg;
    ...
    icmp_ln134_fu_417_p2 <= "1" when (y_fu_124 = add_ln134_1_reg_621) else "0";
    loopWidth_cast_fu_389_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(width_dout),13));
    stream_csc_din <= grp_v_csc_core_Pipeline_VITIS_LOOP_136_2_fu_348_stream_csc_din;

    stream_csc_write_assign_proc : process(grp_v_csc_core_Pipeline_VITIS_LOOP_136_2_fu_348_stream_csc_write, ap_CS_fsm_state3)
    begin
    ...
    stream_in_read_assign_proc : process(grp_v_csc_core_Pipeline_VITIS_LOOP_136_2_fu_348_stream_in_read, ap_CS_fsm_state3)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            stream_in_read <= grp_v_csc_core_Pipeline_VITIS_LOOP_136_2_fu_348_stream_in_read;
        else 
    ...
    y_3_fu_438_p2 <= std_logic_vector(unsigned(y_fu_124) + unsigned(ap_const_lv13_1));
    zext_ln134_fu_422_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(y_fu_124),16));
end behav;
