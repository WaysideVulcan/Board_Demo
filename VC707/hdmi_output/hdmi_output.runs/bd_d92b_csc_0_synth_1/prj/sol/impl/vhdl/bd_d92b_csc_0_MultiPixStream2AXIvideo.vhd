...
attribute shreg_extract : string;
    ...
    signal grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_664_2_fu_120_m_axis_video_TDATA : STD_LOGIC_VECTOR (39 downto 0);
    signal grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_664_2_fu_120_m_axis_video_TVALID : STD_LOGIC;
    signal grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_664_2_fu_120_m_axis_video_TKEEP : STD_LOGIC_VECTOR (4 downto 0);
    signal grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_664_2_fu_120_m_axis_video_TSTRB : STD_LOGIC_VECTOR (4 downto 0);
    ...
    signal i_fu_84 : STD_LOGIC_VECTOR (11 downto 0) := "000000000000";
...
begin
    grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_664_2_fu_120 : component bd_d92b_csc_0_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_664_2
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    grp_reg_unsigned_short_s_fu_145 : component bd_d92b_csc_0_reg_unsigned_short_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        d => Height_dout,
    ...
    grp_reg_unsigned_short_s_fu_151 : component bd_d92b_csc_0_reg_unsigned_short_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        d => WidthOut_dout,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((ap_const_logic_1 = ap_CS_fsm_state3) and (icmp_ln662_fu_171_p2 = ap_const_lv1_0))) then 
    ...
    ap_NS_fsm_assign_proc : process (ap_CS_fsm, ap_CS_fsm_state1, grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_664_2_fu_120_ap_done, ap_block_state1, ap_CS_fsm_state4, ap_CS_fsm_state3, icmp_ln662_fu_171_p2, ap_CS_fsm_state5, regslice_both_m_axis_video_V_data_V_U_apdone_blk)
    begin
        case ap_CS_fsm is
    ...
    WidthOut_read_assign_proc : process(ap_CS_fsm_state1, ap_block_state1)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_const_boolean_0 = ap_block_state1))) then 
    ...
    icmp_ln662_fu_171_p2 <= "1" when (i_fu_84 = rows_reg_199) else "0";
