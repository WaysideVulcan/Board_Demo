...
#(parameter
    ...
    output wire [13:0]                   ROffset,
    output wire [13:0]                   GOffset,
    output wire [13:0]                   BOffset,
    output wire [11:0]                   ClampMin,
    output wire [11:0]                   ClipMax,
    ...
    output wire [13:0]                   ROffset_2,
    output wire [13:0]                   GOffset_2,
    output wire [13:0]                   BOffset_2,
    output wire [11:0]                   ClampMin_2,
    output wire [11:0]                   ClipMax_2,
...
//------------------------Local signal-------------------
    ...
    reg  [15:0]                   int_K32 = 'b0;
    reg  [15:0]                   int_K33 = 'b0;
    reg  [13:0]                   int_ROffset = 'b0;
    reg  [13:0]                   int_GOffset = 'b0;
    reg  [13:0]                   int_BOffset = 'b0;
    reg  [11:0]                   int_ClampMin = 'b0;
    reg  [11:0]                   int_ClipMax = 'b0;
    ...
    reg  [13:0]                   int_ROffset_2 = 'b0;
    reg  [13:0]                   int_GOffset_2 = 'b0;
    reg  [13:0]                   int_BOffset_2 = 'b0;
    reg  [11:0]                   int_ClampMin_2 = 'b0;
    reg  [11:0]                   int_ClipMax_2 = 'b0;
        ...
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_ROFFSET_DATA_0: begin
                    rdata <= int_ROffset[13:0];
                end
                ADDR_GOFFSET_DATA_0: begin
                    rdata <= int_GOffset[13:0];
                end
                ADDR_BOFFSET_DATA_0: begin
                    rdata <= int_BOffset[13:0];
                end
                ADDR_CLAMPMIN_DATA_0: begin
                    rdata <= int_ClampMin[11:0];
                end
                ADDR_CLIPMAX_DATA_0: begin
                    rdata <= int_ClipMax[11:0];
                end
                ...
                ADDR_ROFFSET_2_DATA_0: begin
                    rdata <= int_ROffset_2[13:0];
                end
                ADDR_GOFFSET_2_DATA_0: begin
                    rdata <= int_GOffset_2[13:0];
                end
                ADDR_BOFFSET_2_DATA_0: begin
                    rdata <= int_BOffset_2[13:0];
                end
                ADDR_CLAMPMIN_2_DATA_0: begin
                    rdata <= int_ClampMin_2[11:0];
                end
                ADDR_CLIPMAX_2_DATA_0: begin
                    rdata <= int_ClipMax_2[11:0];
                end
            endcase
        end
    end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_ROFFSET_DATA_0)
            int_ROffset[13:0] <= (WDATA[31:0] & wmask) | (int_ROffset[13:0] & ~wmask);
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_GOFFSET_DATA_0)
            int_GOffset[13:0] <= (WDATA[31:0] & wmask) | (int_GOffset[13:0] & ~wmask);
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_BOFFSET_DATA_0)
            int_BOffset[13:0] <= (WDATA[31:0] & wmask) | (int_BOffset[13:0] & ~wmask);
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_CLAMPMIN_DATA_0)
            int_ClampMin[11:0] <= (WDATA[31:0] & wmask) | (int_ClampMin[11:0] & ~wmask);
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_CLIPMAX_DATA_0)
            int_ClipMax[11:0] <= (WDATA[31:0] & wmask) | (int_ClipMax[11:0] & ~wmask);
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        int_ROffset_2[13:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_ROFFSET_2_DATA_0)
            int_ROffset_2[13:0] <= (WDATA[31:0] & wmask) | (int_ROffset_2[13:0] & ~wmask);
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        int_GOffset_2[13:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_GOFFSET_2_DATA_0)
            int_GOffset_2[13:0] <= (WDATA[31:0] & wmask) | (int_GOffset_2[13:0] & ~wmask);
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        int_BOffset_2[13:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_BOFFSET_2_DATA_0)
            int_BOffset_2[13:0] <= (WDATA[31:0] & wmask) | (int_BOffset_2[13:0] & ~wmask);
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        int_ClampMin_2[11:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_CLAMPMIN_2_DATA_0)
            int_ClampMin_2[11:0] <= (WDATA[31:0] & wmask) | (int_ClampMin_2[11:0] & ~wmask);
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        int_ClipMax_2[11:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_CLIPMAX_2_DATA_0)
            int_ClipMax_2[11:0] <= (WDATA[31:0] & wmask) | (int_ClipMax_2[11:0] & ~wmask);
    end
end
