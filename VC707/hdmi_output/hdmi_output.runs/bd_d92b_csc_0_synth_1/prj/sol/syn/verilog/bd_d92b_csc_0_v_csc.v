...
(* CORE_GENERATION_INFO="bd_d92b_csc_0_v_csc,hls_ip_2023_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7vx485t-ffg1761-2,HLS_INPUT_CLOCK=6.737000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=4.782000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=6419,HLS_SYN_LUT=7008,HLS_VERSION=2023_2}" *)
...
wire    ap_channel_done_HwReg_height_c14_channel;
wire    HwReg_height_c14_channel_full_n;
reg    ap_sync_reg_channel_write_HwReg_height_c14_channel;
wire    ap_sync_channel_write_HwReg_height_c14_channel;
wire    ap_channel_done_HwReg_width_c12_channel;
wire    HwReg_width_c12_channel_full_n;
reg    ap_sync_reg_channel_write_HwReg_width_c12_channel;
...
wire   [11:0] AXIvideo2MultiPixStream_U0_HwReg_width_c11_din;
wire    AXIvideo2MultiPixStream_U0_HwReg_width_c11_write;
wire   [11:0] AXIvideo2MultiPixStream_U0_HwReg_height_c13_din;
wire    AXIvideo2MultiPixStream_U0_HwReg_height_c13_write;
...
wire   [11:0] v_csc_core_U0_HwReg_width_c_din;
wire    v_csc_core_U0_HwReg_width_c_write;
wire   [11:0] v_csc_core_U0_HwReg_height_c_din;
...
wire   [39:0] MultiPixStream2AXIvideo_U0_m_axis_video_TDATA;
wire    MultiPixStream2AXIvideo_U0_m_axis_video_TVALID;
wire   [4:0] MultiPixStream2AXIvideo_U0_m_axis_video_TKEEP;
wire   [4:0] MultiPixStream2AXIvideo_U0_m_axis_video_TSTRB;
...
wire   [11:0] HwReg_ClampMin_channel_dout;
...
wire   [11:0] HwReg_ClipMax_channel_dout;
...
wire   [2:0] HwReg_ROffset_2_channel_num_data_valid;
wire   [2:0] HwReg_ROffset_2_channel_fifo_cap;
wire    HwReg_ROffset_2_channel_empty_n;
wire   [13:0] HwReg_GOffset_2_channel_dout;
wire   [2:0] HwReg_GOffset_2_channel_num_data_valid;
wire   [2:0] HwReg_GOffset_2_channel_fifo_cap;
wire    HwReg_GOffset_2_channel_empty_n;
wire   [13:0] HwReg_BOffset_2_channel_dout;
wire   [2:0] HwReg_BOffset_2_channel_num_data_valid;
wire   [2:0] HwReg_BOffset_2_channel_fifo_cap;
wire    HwReg_BOffset_2_channel_empty_n;
wire   [11:0] HwReg_ClampMin_2_channel_dout;
wire   [2:0] HwReg_ClampMin_2_channel_num_data_valid;
wire   [2:0] HwReg_ClampMin_2_channel_fifo_cap;
wire    HwReg_ClampMin_2_channel_empty_n;
wire   [11:0] HwReg_ClipMax_2_channel_dout;
wire   [2:0] HwReg_ClipMax_2_channel_num_data_valid;
wire   [2:0] HwReg_ClipMax_2_channel_fifo_cap;
wire    HwReg_ClipMax_2_channel_empty_n;
wire   [11:0] HwReg_width_c12_channel_dout;
wire   [2:0] HwReg_width_c12_channel_num_data_valid;
wire   [2:0] HwReg_width_c12_channel_fifo_cap;
wire    HwReg_width_c12_channel_empty_n;
wire   [11:0] HwReg_height_c14_channel_dout;
wire   [2:0] HwReg_height_c14_channel_num_data_valid;
wire   [2:0] HwReg_height_c14_channel_fifo_cap;
...
wire   [2:0] HwReg_width_c11_num_data_valid;
wire   [2:0] HwReg_width_c11_fifo_cap;
wire    HwReg_width_c11_empty_n;
wire    HwReg_height_c13_full_n;
wire   [11:0] HwReg_height_c13_dout;
wire   [2:0] HwReg_height_c13_num_data_valid;
wire   [2:0] HwReg_height_c13_fifo_cap;
...
initial begin
#0 ap_sync_reg_channel_write_HwReg_height_c14_channel = 1'b0;
#0 ap_sync_reg_channel_write_HwReg_width_c12_channel = 1'b0;
...
bd_d92b_csc_0_fifo_w16_d3_S HwReg_ColStart_channel_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_d92b_csc_0_fifo_w16_d3_S HwReg_RowStart_channel_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_d92b_csc_0_fifo_w16_d3_S HwReg_RowEnd_channel_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_d92b_csc_0_fifo_w16_d3_S HwReg_K11_channel_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_d92b_csc_0_fifo_w16_d3_S HwReg_K12_channel_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_d92b_csc_0_fifo_w16_d3_S HwReg_K13_channel_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_d92b_csc_0_fifo_w16_d3_S HwReg_K21_channel_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_d92b_csc_0_fifo_w16_d3_S HwReg_K22_channel_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_d92b_csc_0_fifo_w16_d3_S HwReg_K23_channel_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_d92b_csc_0_fifo_w16_d3_S HwReg_K31_channel_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_d92b_csc_0_fifo_w16_d3_S HwReg_K32_channel_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_d92b_csc_0_fifo_w16_d3_S HwReg_K33_channel_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_d92b_csc_0_fifo_w14_d3_S HwReg_ROffset_channel_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_d92b_csc_0_fifo_w14_d3_S HwReg_GOffset_channel_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_d92b_csc_0_fifo_w14_d3_S HwReg_BOffset_channel_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_d92b_csc_0_fifo_w12_d3_S HwReg_ClampMin_channel_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_d92b_csc_0_fifo_w12_d3_S HwReg_ClipMax_channel_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_d92b_csc_0_fifo_w16_d3_S HwReg_K11_2_channel_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_d92b_csc_0_fifo_w16_d3_S HwReg_K12_2_channel_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_d92b_csc_0_fifo_w16_d3_S HwReg_K13_2_channel_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_d92b_csc_0_fifo_w16_d3_S HwReg_K21_2_channel_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_d92b_csc_0_fifo_w16_d3_S HwReg_K22_2_channel_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_d92b_csc_0_fifo_w16_d3_S HwReg_K23_2_channel_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_d92b_csc_0_fifo_w16_d3_S HwReg_K31_2_channel_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_d92b_csc_0_fifo_w16_d3_S HwReg_K32_2_channel_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_d92b_csc_0_fifo_w16_d3_S HwReg_K33_2_channel_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_d92b_csc_0_fifo_w14_d3_S HwReg_ROffset_2_channel_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_d92b_csc_0_fifo_w14_d3_S HwReg_GOffset_2_channel_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_d92b_csc_0_fifo_w12_d3_S HwReg_ClipMax_2_channel_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_d92b_csc_0_fifo_w12_d2_S HwReg_width_c12_channel_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_d92b_csc_0_fifo_w12_d2_S HwReg_height_c14_channel_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_d92b_csc_0_fifo_w36_d16_S stream_in_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_d92b_csc_0_fifo_w12_d2_S HwReg_width_c11_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_d92b_csc_0_fifo_w12_d2_S HwReg_width_c_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ap_sync_reg_channel_write_HwReg_height_c14_channel <= 1'b0;
    end else begin
        if (((Block_entry3_proc_U0_ap_done & Block_entry3_proc_U0_ap_continue) == 1'b1)) begin
            ap_sync_reg_channel_write_HwReg_height_c14_channel <= 1'b0;
        end else begin
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ap_sync_reg_channel_write_HwReg_width_c12_channel <= 1'b0;
    end else begin
        if (((Block_entry3_proc_U0_ap_done & Block_entry3_proc_U0_ap_continue) == 1'b1)) begin
            ap_sync_reg_channel_write_HwReg_width_c12_channel <= 1'b0;
        end else begin
...
assign ap_sync_channel_write_HwReg_height_c14_channel = ((ap_channel_done_HwReg_height_c14_channel & HwReg_height_c14_channel_full_n) | ap_sync_reg_channel_write_HwReg_height_c14_channel);

assign ap_sync_channel_write_HwReg_width_c12_channel = ((ap_channel_done_HwReg_width_c12_channel & HwReg_width_c12_channel_full_n) | ap_sync_reg_channel_write_HwReg_width_c12_channel);
