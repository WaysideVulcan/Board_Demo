...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.FREQ_HZ {125000000}  ] $sgmii_mgt_clk
  ...
  set_property -dict [ list CONFIG.C_TAVDV_PS_MEM_0 {130000} CONFIG.C_TCEDV_PS_MEM_0 {130000} CONFIG.C_THZCE_PS_MEM_0 {35000} CONFIG.C_TLZWE_PS_MEM_0 {35000} CONFIG.C_TPACC_PS_FLASH_0 {25000} CONFIG.C_TWC_PS_MEM_0 {13000} CONFIG.C_TWPH_PS_MEM_0 {12000} CONFIG.C_TWP_PS_MEM_0 {70000} CONFIG.C_WR_REC_TIME_MEM_0 {100000} CONFIG.EMC_BOARD_INTERFACE {linear_flash} CONFIG.USE_BOARD_FLOW {true}  ] $axi_emc_0

  # Create instance: axi_ethernet_0, and set properties
  set axi_ethernet_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_ethernet:7.0 axi_ethernet_0 ]
  set_property -dict [ list CONFIG.DIFFCLK_BOARD_INTERFACE {sgmii_mgt_clk} CONFIG.ETHERNET_BOARD_INTERFACE {sgmii} CONFIG.Frame_Filter {false} CONFIG.MDIO_BOARD_INTERFACE {mdio_mdc} CONFIG.PHYRST_BOARD_INTERFACE {phy_reset_out} CONFIG.RXMEM {32k} CONFIG.Statistics_Counters {false} CONFIG.TXMEM {32k}  ] $axi_ethernet_0
  ...
  set axi_ethernet_0_refclk [ create_bd_cell -type ip -vlnv xilinx.com:ip:clk_wiz:5.1 axi_ethernet_0_refclk ]
  set_property -dict [ list CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {200} CONFIG.PRIM_SOURCE {Single_ended_clock_capable_pin} CONFIG.USE_LOCKED {false} CONFIG.USE_RESET {false}  ] $axi_ethernet_0_refclk

  # Create instance: axi_gpio_0, and set properties
  set axi_gpio_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 axi_gpio_0 ]
  set_property -dict [ list CONFIG.GPIO_BOARD_INTERFACE {dip_switches_8bits} CONFIG.USE_BOARD_FLOW {true}  ] $axi_gpio_0

  # Create instance: axi_gpio_1, and set properties
  set axi_gpio_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 axi_gpio_1 ]
  set_property -dict [ list CONFIG.GPIO_BOARD_INTERFACE {lcd_7bits} CONFIG.USE_BOARD_FLOW {true}  ] $axi_gpio_1
  ...
  set_property -dict [ list CONFIG.GPIO_BOARD_INTERFACE {rotary_switch} CONFIG.USE_BOARD_FLOW {true}  ] $axi_gpio_4

  # Create instance: axi_iic_0, and set properties
  set axi_iic_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_iic:2.0 axi_iic_0 ]
  set_property -dict [ list CONFIG.C_DEFAULT_VALUE {0xFF} CONFIG.C_GPO_WIDTH {2} CONFIG.C_SCL_INERTIAL_DELAY {5} CONFIG.C_SDA_INERTIAL_DELAY {5} CONFIG.IIC_BOARD_INTERFACE {iic_main} CONFIG.USE_BOARD_FLOW {true}  ] $axi_iic_0

  # Create instance: axi_mem_intercon, and set properties
  set axi_mem_intercon [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 axi_mem_intercon ]
  set_property -dict [ list CONFIG.NUM_MI {2} CONFIG.NUM_SI {5}  ] $axi_mem_intercon
  ...
  set_property -dict [ list CONFIG.BOARD_MIG_PARAM {ddr3_sdram} CONFIG.RESET_BOARD_INTERFACE {reset} CONFIG.XML_INPUT_FILE {mig_b.prj}  ] $mig_7series_0
  ...
  set_property -dict [ list CONFIG.CHANNEL_ENABLE_TEMPERATURE {true} CONFIG.CHANNEL_ENABLE_VAUXP0_VAUXN0 {true} CONFIG.CHANNEL_ENABLE_VAUXP8_VAUXN8 {true} CONFIG.CHANNEL_ENABLE_VP_VN {true} CONFIG.ENABLE_TEMP_BUS {true} CONFIG.SEQUENCER_MODE {Off} CONFIG.XADC_STARUP_SELECTION {simultaneous_sampling}  ] $xadc_wiz_0
  ...
  create_bd_addr_seg -range 0x8000000 -offset 0x60000000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs axi_emc_0/S_AXI_MEM/MEM0] SEG_axi_emc_0_MEM0
  ...
  create_bd_addr_seg -range 0x10000 -offset 0x40040000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs axi_gpio_4/S_AXI/Reg] SEG_axi_gpio_4_Reg
  ...
  create_bd_addr_seg -range 0x10000 -offset 0x44A00000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs axi_uart16550_0/S_AXI/Reg] SEG_axi_uart16550_0_Reg
