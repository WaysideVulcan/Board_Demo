...
#
# Script generated by Vivado on Mon May 06 11:29:02 +0800 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : vc707_pcie_x8_gen2.sh
...
#
# Usage        : vc707_pcie_x8_gen2.sh
#                vc707_pcie_x8_gen2.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                vc707_pcie_x8_gen2.sh [-reset_run]
#                vc707_pcie_x8_gen2.sh [-reset_log]
#                vc707_pcie_x8_gen2.sh [-help]
#
...
# script info
echo -e "vc707_pcie_x8_gen2.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./vc707_pcie_x8_gen2.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot vc707_pcie_x8_gen2 xil_defaultlib.vc707_pcie_x8_gen2 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim vc707_pcie_x8_gen2 -key {Behavioral:sim_1:Functional:vc707_pcie_x8_gen2} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb vc707_pcie_x8_gen2.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./vc707_pcie_x8_gen2.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: vc707_pcie_x8_gen2.sh [-help]\n\
Usage: vc707_pcie_x8_gen2.sh [-step]\n\
Usage: vc707_pcie_x8_gen2.sh [-lib_map_path]\n\
Usage: vc707_pcie_x8_gen2.sh [-reset_run]\n\
Usage: vc707_pcie_x8_gen2.sh [-reset_log]\n\
Usage: vc707_pcie_x8_gen2.sh [-keep_index]\n\
Usage: vc707_pcie_x8_gen2.sh [-noclean_files]\n\n\
