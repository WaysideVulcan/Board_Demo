...
-- Command     : write_vhdl -force -mode funcsim -rename_top versal_ibert_util_ds_buf_5_0 -prefix
--               versal_ibert_util_ds_buf_5_0_ versal_ibert_util_ds_buf_6_0_sim_netlist.vhdl
...
entity versal_ibert_util_ds_buf_5_0_util_ds_buf is
  port (
  ...
  attribute C_BUFGCE_DIV of versal_ibert_util_ds_buf_5_0_util_ds_buf : entity is 1;
  attribute C_BUFG_GT_SYNC : integer;
  attribute C_BUFG_GT_SYNC of versal_ibert_util_ds_buf_5_0_util_ds_buf : entity is 0;
  attribute C_BUF_TYPE : string;
  attribute C_BUF_TYPE of versal_ibert_util_ds_buf_5_0_util_ds_buf : entity is "ibufds_gtme5";
  attribute C_MODE : string;
  attribute C_MODE of versal_ibert_util_ds_buf_5_0_util_ds_buf : entity is "PERFORMANCE";
  attribute C_OBUFDS_GTE5_ADV : string;
  attribute C_OBUFDS_GTE5_ADV of versal_ibert_util_ds_buf_5_0_util_ds_buf : entity is "2'b00";
  attribute C_REFCLK_ICNTL_TX : string;
  attribute C_REFCLK_ICNTL_TX of versal_ibert_util_ds_buf_5_0_util_ds_buf : entity is "5'b00000";
  attribute C_SIM_DEVICE : string;
  attribute C_SIM_DEVICE of versal_ibert_util_ds_buf_5_0_util_ds_buf : entity is "VERSAL_AI_CORE_ES1";
  attribute C_SIZE : integer;
  attribute C_SIZE of versal_ibert_util_ds_buf_5_0_util_ds_buf : entity is 1;
end versal_ibert_util_ds_buf_5_0_util_ds_buf;

architecture STRUCTURE of versal_ibert_util_ds_buf_5_0_util_ds_buf is
...
entity versal_ibert_util_ds_buf_5_0 is
  ...
  attribute NotValidForBitStream of versal_ibert_util_ds_buf_5_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of versal_ibert_util_ds_buf_5_0 : entity is "versal_ibert_util_ds_buf_6_0,util_ds_buf,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of versal_ibert_util_ds_buf_5_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of versal_ibert_util_ds_buf_5_0 : entity is "util_ds_buf,Vivado 2023.2";
end versal_ibert_util_ds_buf_5_0;

architecture STRUCTURE of versal_ibert_util_ds_buf_5_0 is
...
begin
U0: entity work.versal_ibert_util_ds_buf_5_0_util_ds_buf
     port map (
      BUFGCE_CE(0) => '0',
      BUFGCE_CLR(0) => '0',
      BUFGCE_I(0) => '0',
