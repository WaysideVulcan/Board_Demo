...
ISEStep( "vivado",
         "-log versal_ibert_bridge_refclkGTM_REFCLK_X0Y0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source versal_ibert_bridge_refclkGTM_REFCLK_X0Y0_0.tcl" );
