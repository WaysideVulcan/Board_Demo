...
HD_PWD='C:/Vulcan/Design_Tool/Board_Demo/VC707/versal_ibert/versal_ibert.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log versal_ibert_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source versal_ibert_wrapper.tcl -notrace
