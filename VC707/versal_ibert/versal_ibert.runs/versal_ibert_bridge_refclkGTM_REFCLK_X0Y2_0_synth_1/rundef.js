...
ISEStep( "vivado",
         "-log versal_ibert_bridge_refclkGTM_REFCLK_X0Y2_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source versal_ibert_bridge_refclkGTM_REFCLK_X0Y2_0.tcl" );
