...
HD_PWD='C:/Vulcan/Design_Tool/Board_Demo/VC707/versal_ibert/versal_ibert.runs/versal_ibert_util_ds_buf_6_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log versal_ibert_util_ds_buf_6_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source versal_ibert_util_ds_buf_6_0.tcl
